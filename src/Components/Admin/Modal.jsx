  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      ...
      <form onSubmit={handleSubmit}>
        <TextField name='firstName' value={firstName} onChange={handleAddFirstName}/>
        <TextField name='lastName' value={lastName} onChange={handleAddLastName}/>
        <TextField name='patronymic' value={patronymic} onChange={handleAddPatronymic}/>
